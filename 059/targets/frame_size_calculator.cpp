...
// void udf::frame_size_calculator::do_tuple_index_node(udf::tuple_index_node *const node, int lvl) {
//   // EMPTY
// }
...
void udf::frame_size_calculator::do_tensor_dimensions_node(udf::tensor_dimensions_node * const node, int lvl) {
  // EMPTY
}

void udf::frame_size_calculator::do_tensor_dimension_node(udf::tensor_dimension_node * const node, int lvl) {
  // EMPTY
}
